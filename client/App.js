...
class App extends React.Component {
  constructor(props) {
    ...
    this.sendRequestForProfilePicture = this.sendRequestForProfilePicture.bind(this)
    this.handleProfilePictureDownloaded = this.handleProfilePictureDownloaded.bind(this)
    this.handleProfilePictureRemoved = this.handleProfilePictureRemoved.bind(this)
    this.handleProfilePictureUpdated = this.handleProfilePictureUpdated.bind(this)
  }
    ...
    return (
      <NavigationContainer>
        <DetailsContext.Provider
          value={{
            isProfilePictureDownloaded: this.state.isProfilePictureDownloaded,
            profilePictureDetails: this.state.profilePictureDetails,
            userDetails: this.state.userDetails,
            handleProfilePictureRemoved: this.handleProfilePictureRemoved,
            handleProfilePictureUpdated: this.handleProfilePictureUpdated,
            apolloClient: client
          }}>
